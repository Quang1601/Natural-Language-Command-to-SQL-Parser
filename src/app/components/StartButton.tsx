export const StartButton = ({ onClick }: { onClick?: () => void }) => {
  return (
    <div onClick={onClick} className="relative w-[406px] h-[197px] flex justify-center items-center cursor-pointer shrink-0 z-10 transition-transform active:scale-95">
      <div className="relative w-[400px] h-[123px] rounded-[24px] z-20 flex justify-center items-center overflow-hidden bg-black border-[3px] border-[#282828]">
